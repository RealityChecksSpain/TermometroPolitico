const DICCIONARIO = [
  ['autonomos', ['autonom', 'freelance', 'por cuenta propia', 'cuota de autonom', 'trabajo por mi cuenta', 'facturo']],
  ['trabajadores', ['trabajador', 'empleado', 'asalariado', 'por cuenta ajena', 'tengo un contrato', 'mi jefe', 'nomina', 'nómina', 'convenio']],
  ['pensionistas', ['pensionista', 'jubilad', 'mi pension', 'mi pensión', 'cobro una pension']],
  ['desempleados', ['paro', 'desemplead', 'sin trabajo', 'busco trabajo', 'subsidio', 'prestacion por desempleo']],
  ['inquilinos', ['alquiler', 'inquilin', 'de alquiler', 'arriendo', 'mi casero', 'pago renta']],
  ['propietarios', ['propietari', 'hipoteca', 'mi vivienda', 'casero', 'arrendador', 'compre un piso']],
  ['familias', ['hijo', 'hija', 'madre', 'padre', 'familia', 'guarderia', 'guardería', 'concilia', 'permiso de paternidad', 'maternidad']],
  ...
  ['migrantes', ['migrante', 'inmigrante', 'extranjer', 'papeles', 'nacionalidad', 'asilo', 'refugiad', 'nie', 'arraigo', 'permiso de residencia', 'venezolan', 'marroqu', 'colombian']],
  ...
  ['pymes', ['pyme', 'peque a empresa', 'pequeña empresa', 'micro empresa', 'microempresa', 'negocio', 'tienda', 'comercio propio', 'restaurante', 'cafeteria', 'peluqueria', 'taller', 'emprendedor', 'autoempleo', 'tengo un bar', 'tengo una empresa']],
  ['grandes_empresas', ['multinacional', 'gran empresa', 'cotizada', 'corporacion']],
  ['agricultores', ['agricultor', 'ganader', 'en el campo', 'agrari', 'cultivo', 'la pac', 'olivar', 'viñedo', 'tractor', 'huerta', 'cosecha', 'regadio', 'invernadero']],
  ['pescadores', ['pescador', 'pesca', 'marinero', 'flota', 'barco de pesca', 'caladero']],
  ['sanitarios', ['medic', 'médic', 'enfermer', 'sanitari', 'hospital', 'atencion primaria', 'ambulatorio']],
  ['docentes', ['profesor', 'maestr', 'docente', 'doy clase', 'instituto', 'colegio']],
  ['funcionarios', ['funcionari', 'empleado publico', 'empleado público', 'administracion publica', 'interino']],
  ...
  ['conductores', ['conduzco', 'conductor', 'coche', 'carnet', 'itv', 'multa de trafico', 'moto']],
  ['sector_cultural', ['artista', 'musico', 'músico', 'actor', 'actriz', 'cultura', 'cine', 'teatro', 'escritor']],
  ['sanidad_pacientes', ['paciente', 'enfermedad', 'tratamiento', 'medicamento', 'lista de espera', 'cronic']],
